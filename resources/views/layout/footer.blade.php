<div class="footer">
    <div class="footer-container d-flex flex-column flex-md-row bd-highlight justify-content-between">
        <div class="left d-flex flex-column">
            <img src="{{secure_asset('assets/img/Logo_ALTERNATIVE.png') }}" alt="">
        ...
        <div class="middle d-flex flex-column">
            ...
            <div class="social-icons flex-row">
                ...
                <img src="{{secure_asset('assets/img/facebook.png') }}" alt="">
                <img src="{{secure_asset('assets/img/instagram.png') }}" alt="">
            </div>
        </div>
