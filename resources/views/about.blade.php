...
<div class="page">
    <div class="about-one">
        <img src="{{secure_asset('assets/img/about1.jpg') }}">
    ...
    <div class="stats d-flex flex-column flex-md-row bd-highlight justify-content-evenly">
        <div class="stats-content d-flex flex-column bd-highlight align-items-center">
            <img src="{{secure_asset('assets/img/about-user.png') }}">
            <h4>1.000+</h4>
            <p>{{ __('about.active_users') }}</p>
        </div>
        <div class="stats-content d-flex flex-column bd-highlight align-items-center">
            <img src="{{secure_asset('assets/img/about-donation.png') }}">
            <h4>3.000+</h4>
            <p>{{ __('about.donation_gathered') }}</p>
        </div>
        <div class="stats-content d-flex flex-column bd-highlight align-items-center">
            <img src="{{secure_asset('assets/img/about-food.png') }}">
            <h4>7.000+</h4>
    ...
    <div class="about-two">
        <div class="about-extended d-flex flex-column flex-md-row bd-highlight align-items-center">
            <img src="{{secure_asset('assets/img/about2.jpg') }}">
        ...
        <div class="about-extended d-flex flex-column flex-md-row bd-highlight align-items-center">
            ...
            <img src="{{secure_asset('assets/img/about3.jpg') }}">
        </div>
    </div>
</div>
@endsection
